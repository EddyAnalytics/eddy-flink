...
RUN wget http://central.maven.org/maven2/org/apache/flink/flink-sql-connector-kafka_2.11/1.9.0/flink-sql-connector-kafka_2.11-1.9.0.jar \
    ...
    && wget http://central.maven.org/maven2/org/apache/flink/flink-sql-connector-kafka-0.9_2.11/1.9.0/flink-sql-connector-kafka-0.9_2.11-1.9.0.jar \
    ...
    && wget http://central.maven.org/maven2/org/apache/flink/flink-json/1.9.0/flink-json-1.9.0-sql-jar.jar \
